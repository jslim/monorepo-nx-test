...
import { PageTitle } from '@jose-monorepo/ui-header';
import { ApiResponse, API_URL } from '@jose-monorepo/api-interface';
      ...
      <div className="wrapper">
        <div className="container">
          ...
          <div id="hero" className="rounded">
            <div className="text-container">{apiResponse.message}</div>
          </div>
